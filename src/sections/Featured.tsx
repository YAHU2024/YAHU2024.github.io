        ...
        <Reveal>
          <div className="mb-9 flex items-baseline justify-between gap-4">
            <h2 className="text-3xl font-black">
              <span className="mr-3 text-base font-bold text-accent">{copy.featured.num}</span>
              {copy.featured.title}
            </h2>
            <a
            ...
            >
              {copy.featured.allOnGitHub} <span className="ar-pop">→</span>
            </a>
          </div>
        </Reveal>
              ...
              <GlassCard className="h-full p-7" tilt>
                ...
                <div className="gc-z2 mt-5 flex flex-wrap items-center gap-x-4 gap-y-1">
                  {p.homepage && (
                    ...
                    >
                      {copy.featured.projectHomepage} <ArrowUpRight className="ar-pop h-3.5 w-3.5" />
                    </a>
                  )}
                  <a
                    href={p.url}
                    ...
                    className="inline-flex items-center gap-1 text-sm font-extrabold text-accent hover:underline"
                  >
                    {copy.featured.github} <ArrowUpRight className="ar-pop h-3.5 w-3.5" />
                  </a>
                </div>
              </GlassCard>
            </Reveal>
